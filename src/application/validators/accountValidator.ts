...
export const CreateAccountSchema = z
  .object({
    ...
    currency: z
      .string()
      .length(3, 'La moneda debe ser un código de 3 letras (ej: CLP, USD)')
      .default('CLP'),
    ...
    cardNumber: z
      .string()
      .regex(/^\d{4}$/, 'Últimos 4 dígitos de la tarjeta (ejemplo: 1234)')
      .optional(),
  ...
  .refine(
    ...
    {
      message:
        'Las tarjetas de crédito y líneas de crédito requieren límite, día de corte y días de pago',
      path: ['creditLimit'],
    }
  );
...
export const UpdateAccountSchema = z.object({
  ...
  type: z
    .enum(['CHECKING', 'SAVINGS', 'CREDIT_CARD', 'CASH', 'INVESTMENT', 'LINE_OF_CREDIT'])
    .optional(),
