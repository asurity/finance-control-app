...
export function DebtSummaryWidget() {
      ...
      <Card>
        ...
        <CardContent>
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Error al cargar resumen de deudas: {error instanceof Error ? error.message : 'Error desconocido'}
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
  ...
  const netWorthColor = netWorth >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500';
  const netWorthIcon = netWorth >= 0 ? '↑' : '↓';

  // Get top 3 credit cards by debt amount
  const topCreditCards = [...creditCards]
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center py-3 px-4 bg-muted/50 rounded-lg">
          ...
          <div className="flex items-center justify-center gap-1">
            <span className={`text-2xl font-bold ${netWorthColor}`}>
              {netWorthIcon}
            </span>
            <MoneyDisplay 
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center text-sm">
            ...
            <MoneyDisplay amount={totalAssets} type="balance" className="font-medium" showSign={false} />
          </div>
          ...
          <div className="flex justify-between items-center text-sm">
            ...
            <MoneyDisplay amount={totalDebt} type="expense" className="font-medium" showSign={false} />
          </div>
